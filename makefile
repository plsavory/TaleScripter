...
GAME_COMPILER_FILES = Game/Src/GameCompilerEntryPoint.cpp Game/Src/GameCompiler/GameCompiler.cpp Game/Src/GameCompiler/ProjectBuilder.cpp Game/Src/GameCompiler/ChapterBuilder.cpp Game/Src/Misc/Utils.cpp
